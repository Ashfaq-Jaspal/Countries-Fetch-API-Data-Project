    ...
    .then((data) => {
        ...
        function showCountries() {
            ...
            data.forEach((country, index) => {
                box += `<div data-index = "${index}" class="country-box" id="country-box">
                <div data-index = "${index}" class = "flag-div">
                <img data-index = "${index}" class = "flag" src="${data[index].flags.png}">
                </div>
                <p data-index = "${index}">${data[index].name.common}</p>
                <i data-index = "${index}" class="ri-arrow-right-line"></i>
            </div>`;
            });
            ...
            function showCountry() {
                countries.addEventListener(`click`, (details) => {
                    if (details.target.id === `country-box`) {
        ...
        searchInput.addEventListener(`input`, () => {
            ...
            function showCountries() {
                ...
                filteredArray.forEach((country, index) => {
                    ...
                    <div data-index = "${index}" class = "flag-div">
                    <img data-index = "${index}" class = "flag" src="${filteredArray[index].flags.png}">
                    </div>
                    <p data-index = "${index}">${filteredArray[index].name.common}</p>
                    <i data-index = "${index}" class="ri-arrow-right-line"></i>
            </div>`;
                });
                countries.innerHTML = box;
